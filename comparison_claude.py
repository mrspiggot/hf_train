...
# Evaluate the pre-trained model (unchanged)
...
...
fine_tuned_accuracy = sum([1 for x, y in zip(fine_tuned_results, test_dataset["label"]) if (x == "POSITIVE" and y == 1) or (x == "NEGATIVE" and y == 0)]) / len(test_dataset)
